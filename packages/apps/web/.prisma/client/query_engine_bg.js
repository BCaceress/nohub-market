...
function G(e) {
  var t = a(e) ? 0 : b(e, _.__wbindgen_malloc, _.__wbindgen_realloc),
    n = s;
...
class k {
  ...
  disconnect(t, n) {
    const r = b(t, _.__wbindgen_malloc, _.__wbindgen_realloc),
      o = s,
      i = b(n, _.__wbindgen_malloc, _.__wbindgen_realloc),
      c = s;
    return _.queryengine_disconnect(this.__wbg_ptr, r, o, i, c);
  }
  startTransaction(t, n, r) {
    const o = b(t, _.__wbindgen_malloc, _.__wbindgen_realloc),
      i = s,
      c = b(n, _.__wbindgen_malloc, _.__wbindgen_realloc),
      u = s,
      f = b(r, _.__wbindgen_malloc, _.__wbindgen_realloc),
      d = s;
  ...
  query(t, n, r, o) {
    const i = b(t, _.__wbindgen_malloc, _.__wbindgen_realloc),
      c = s,
      u = b(n, _.__wbindgen_malloc, _.__wbindgen_realloc),
      f = s;
    var d = a(r) ? 0 : b(r, _.__wbindgen_malloc, _.__wbindgen_realloc),
      h = s;
    const D = b(o, _.__wbindgen_malloc, _.__wbindgen_realloc),
      R = s;
    return _.queryengine_query(this.__wbg_ptr, i, c, u, f, d, h, D, R);
  }
  trace(t) {
    const n = b(t, _.__wbindgen_malloc, _.__wbindgen_realloc),
      r = s;
