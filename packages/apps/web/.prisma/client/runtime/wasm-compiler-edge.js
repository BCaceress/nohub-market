...
function Kt(e, t) {
  ...
  if ((t == null ? ((W = !1), (w = M)) : (w = t), C.eq(10))) return t == null && (W = !0), mi(k, w);
  if (
...
function dn(e) {
  let t = e.showColors ? cp : up,
    r;
  return (
    typeof $getTemplateParameters < "u" ? (r = $getTemplateParameters(e, t)) : (r = pp(e)), mp(r, t)
  );
}
c();
u();
...
function Cc({ copyEngine: e = !0 }, t) {
  ...
  return w
    ...
    : i.accelerate
      ? new Gr(t)
      : (i.driverAdapters, new _o({ clientVersion: t.clientVersion }));
}
var _o = class {
  constructor(t) {
