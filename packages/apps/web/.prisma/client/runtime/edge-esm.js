...
R.toNearest = function (e, t) {
  ...
  return (
    e.d[0] ? ((_ = !1), (r = V(r, e, 0, t, 1).times(e)), (_ = !0), k(r)) : ((e.s = r.s), (r = e)), r
  );
};
R.toNumber = function () {
  return +this;
...
function k(e, t, r, n) {
  ...
  return (
    _ && (e.e > I.maxE ? ((e.d = null), (e.e = NaN)) : e.e < I.minE && ((e.e = 0), (e.d = [0]))), e
  );
}
function ye(e, t, r) {
...
function Cr(e) {
  let t = e.showColors ? Au : Ru,
    r;
  return (
    typeof $getTemplateParameters < "u" ? (r = $getTemplateParameters(e, t)) : (r = Cu(e)), Su(r, t)
  );
}
f();
u();
...
function Fs({ copyEngine: e = !0 }, t) {
  ...
  return i.accelerate ? new yt(t) : (i.driverAdapters, new yt(t));
}
f();
u();
c();
