...
export async function buildOrderItem(
  input: BuildOrderItemInput,
  ...
  if (!priceResult.success) {
    ...
    var unitPrice = Number(legacyPrice.price);
  } else {
    var unitPrice = Number(priceResult.data.effectivePrice);
  }
