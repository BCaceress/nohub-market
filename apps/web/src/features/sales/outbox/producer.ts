...
export type OutboxEventType =
  ...
  | "FISCAL_ISSUE" // Emitir NFCe via BaaS
  | "FISCAL_CANCEL"; // Cancelar NFCe via BaaS
 ...
 */
export async function enqueueOutboxEvent(input: EnqueueOutboxInput): Promise<{ id: string }> {
