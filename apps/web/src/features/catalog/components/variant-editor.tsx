...
export function VariantEditor({ organizationId, productId, variants: initialVariants }: Props) {
  ...
  function addAttr() {
    ...
    setForm((f) => ({
      ...f,
      attributes: { ...f.attributes, [f.attrKey.trim()]: f.attrValue },
      attrKey: "",
      attrValue: "",
    }));
  }
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const input = {
        ...
        isActive: true,
        position: editingVariant?.position ?? variants.length,
      };
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
            <div className="flex flex-col gap-1.5">
              ...
              <Input
                ...
                placeholder="Ex: 350ml, Vermelho, P"
                required
              />
            </div>
            <div className="flex flex-col gap-1.5">
